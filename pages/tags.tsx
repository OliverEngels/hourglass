...
import { Tag, createTags, updateTag } from "@redux/reducers/tags";

const Tags = () => {
    const [search, setSearch] = useState<string>("");
    const [oldId, setOldId] = useState<string>(null);
    const [selectedRows, setSelectedRows] = useState<string[]>([]);
    const [searchOrder, setSearchOrder] = useState<Tag[]>([])
    ...
    const handleSearch = () => {
        if (search == '')
            ...
            setSearchOrder(tags.filter(item => item.value.includes(search)));
        }
    }
        ...
        <>
            <div className="container mx-auto mt-4 mb-10">
                <div className="flex w-full mb-3 justify-start space-x-3">
                    ...
                    <Input value={search} setValueOnChange={handleSearchInput} setValueOnEnter={handleSearch} title="Search" placeholder="Example: C#" />
                    <div className="mt-5 relative flex flex-col items-center" onClick={handleSearch}>
